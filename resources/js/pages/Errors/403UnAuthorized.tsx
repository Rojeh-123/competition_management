...
export default function ForbiddenPage({ message }: ForbiddenPageProps) {
    ...
    return (
        <div className="container mx-auto flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
            <Head title={`403 – ${t('error.403Title')}`} />
                        ...
                        <div className="mt-12 border-t pt-8">
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                                ...
                                >
                                    ...
                                    <p className="font-semibold">{t('nav.competitions')}</p>
                                ...
                                >
                                    ...
                                    <p className="font-semibold">{t('nav.gallery')}</p>
                                    <p className="mt-1 text-sm text-muted-foreground">
                                ...
                                >
                                    <Trophy className="mx-auto mb-3 h-8 w-8 text-primary transition-transform group-hover:scale-110" />
                                    <p className="font-semibold">{t('nav.winners')}</p>
                                    <p className="mt-1 text-sm text-muted-foreground">
